...
const packageName='Yujie_Growth_Workbench_V0.1_AUDIT_RECTIFICATION_02_Windows';
...
try{
  ...
  status.status='GROWTH_WORKBENCH_V0.1_AUDIT_RECTIFICATION_02_READY';
...
await fs.writeFile(path.join(target,'README.md'),[
  ...
  '- `growth_workbench/src/feedback-flywheel.mjs` 同时导出 `rebuildRevisionPairs()`；规则效果分差固定为启用组均分减未启用组均分。',
  ...
  '- `node --test growth_workbench/test/`：执行工单指定的飞轮质量回归入口，无 todo。',
...
const required=[
  ...
  'growth_workbench/src/topic-generator.mjs','growth_workbench/src/content-os-adapter.mjs','growth_workbench/src/gates.mjs','growth_workbench/src/url-content-extractor.mjs',
  'growth_workbench/src/feedback-flywheel.mjs','growth_workbench/public/app.js','growth_workbench/public/styles.css','growth_workbench/test/package.json','growth_workbench/test/flywheel-quality.mjs','growth_workbench/test/usability-quality-fix.mjs','growth_workbench/.env.example'
];
const hashes={};
...
const manifest={
  package:packageName,
  version:'0.1.5',
  status:'GROWTH_WORKBENCH_V0.1_AUDIT_RECTIFICATION_02_READY',
  ...
  lin_style:{style_pack:'1.0.0',fewshot_pack:'1.1.0',default_mode:'lin',pass_threshold:82,api_key_in_package:includeLocalEnv,external_model:'minimax/minimax-m3:free',max_completion_tokens:12000,silent_template_fallback:false,external_grounding_gate:true},
  feedback_flywheel:{schema_version:'feedback_flywheel_v2',rule_activation:'human_confirmation_required',revision_pair_rebuild:'exported_pure_function',effect_avg_score_delta:'mean_applied_minus_mean_not_applied',reconstruction_warning_ui:true,verified_internal_effect:'none',content_os_schema_effect:'none'},
