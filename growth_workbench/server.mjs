...
async function api(req, res, url) {
  ...
  if (method === 'GET' && p === '/api/health') return json(res, 200, { ok: true, workbench: '0.1.5-audit-rectification-02', content_os: adapter.status(), lin_style: styleRuntimeStatus(), feedback_flywheel: 'feedback_flywheel_v2', data_dir: dataDir });
