 ...
 *   OpenRouter LIN_LLM_BASE_URL=https://openrouter.ai/api/v1     LIN_LLM_MODEL=stealth/ox-alpha
 */
...
function defaultConfig() {
  ...
  return {
    ...
    model: process.env.LIN_LLM_MODEL || (openRouter ? 'stealth/ox-alpha' : 'deepseek-chat'),
    temperature: Number(process.env.LIN_LLM_TEMPERATURE ?? 0.85),
    maxTokens: Number(process.env.LIN_LLM_MAX_TOKENS ?? 2000),
